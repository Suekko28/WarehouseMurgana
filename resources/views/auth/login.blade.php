                                    ...
                                    <div class="col-lg-6 d-none d-lg-inline-block">
                                        <div class="auth-page-sidebar">
                                            <div class="auth-user-testimonial">
                                                ...
                                                <p class="fs-20 fw-bold text-white">Jika lupa password mohon konfirmasi ke email arga kencana@murgana.co.id</p>
                    ...
                    <div class="card">
                        <div class="card-body p-0">
                            <div class="row g-0">
                                ...
                                <div class="auth-pages col-lg-6 p-5">
                                    <div class="auth-page-sidebar">
                                        <div class="auth-user-testimonial">
                                            <img class="" src="template/logo.jpg" alt="Logo Murgana">
                                            <p class="fs-20 fw-bold text-white">Jika lupa password mohon konfirmasi ke email arga kencana@murgana.co.id</p>
                                            <button class="btn border-white fw-bold text-white w-100" type="submit">Konfirmasi</button>
                                        </div>
                                </div>
