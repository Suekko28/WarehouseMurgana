            ...
            <caption>List of users</caption>
                ...
                @foreach ($users as $user)
                      ...
                      <th scope="row">{{ $loop->iteration +$id_bef}}</th>                     
                        ...
                        <td>{{$role}}</td>
                        <td>
                          <button type="button" onclick="keluarkan({{$loop->iteration}},{{$user->id}})" id="btn-edit" class="btn btn-warning mb-2" data-bs-toggle="modal" data-bs-target="#editModal"><i class=" fa fa-solid fa-pen-to-square" style="color:white;"></i></button>
                          <a href="{{ url('delete-user/'.$user->id) }}" class="btn btn-danger mb-2"><i class="fa fa-solid fa-trash"></i></a>
                        </td>
                    </tr>
                  @endforeach
                </tbody>
