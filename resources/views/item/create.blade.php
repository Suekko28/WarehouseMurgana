                        ...
                        <div class="modal-body">
                            ...
                            <form action="/perusahaan/detail" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="alat" type="text" class="form-control w-100" id="alat"
                                        aria-describedby="name" value="">
                                </div>
                                <div class="mb-3">
                                    <label for="lokasi" class="form-label">Lokasi</label>
                                    <input name="lokasi" type="text" class="form-control w-100" id="lokasi"
                                ...
                                <div class="mb-3">
                                    <input value="{{ $data->id }}" name="company_id" type="hidden"
                                        class="form-control w-100" id="file">
                                </div>
